...
sba_duties <- c("Applied causal and correlational econometric models, such as Difference-in-Difference, to study economic impact of SBA programs.",
                "Utilized Random Forest and Survival Regresssion models to identify lower-risk sections of the portfolio that could streamline processing to significantly cut processing time while limiting risk.",
